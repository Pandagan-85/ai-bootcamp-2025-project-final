...
SYNONYMS_FOR_INDEX = {
    ...
    'peperoni': ['peperone', 'peperone dolce', 'peperone rosso', 'peperone giallo', 'peperoni rossi', 'peperoni gialli', 'peperone rosso a strisce', 'peperoni misti', 'peperoni rosso a dadini', 'peperoni arrostiti a strisce'],
    'ceci cotti': ['ceci in scatola', 'ceci in lattina', 'ceci secchi', 'ceci lessati', 'ceci precotti', 'ceci in scatola (sciacquati e sgocciolati)', 'ceci sciacquati', 'ceci scolati', 'ceci in scatola (sciacquati e scolati)', 'ceci (sgocciolati e sciacquati)'],
    ...
    'coriandolo': ['coriandolo fresco', 'cilantro', 'coriandolo fresco tritato'],
    ...
    # Chiave: nome CSV norm. Valore: varianti norm.
    'acqua':['acqua minerale', 'acqua naturale'],
...
FALLBACK_MAPPING = {
    ...
    "peperoni misti": "Peperoni",
    "peperoni a dadini": "Peperoni",
    "peperoncino rosso": "Peperoncino",
    "peperoncino verde": "Peperoncino",
    "peperoncino fresco": "Peperoncino",
    ...
    "ceci (sgocciolati e sciacquati)":"Ceci cotti",
