#!/usr/bin/env python3
# simple_workflow_diagram.py - Genera il diagramma del workflow con sintassi corretta
...
def generate_workflow_diagram(output_dir="."):
    """
    Genera un diagramma Mermaid del workflow "Generate then Fix" con sintassi corretta
    ...
    # Codice Mermaid con sintassi corretta (senza operatore &)
